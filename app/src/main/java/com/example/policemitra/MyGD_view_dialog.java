...
public class MyGD_view_dialog {
    ...
    TextView name, email, status, subject, details, doc, location, ps,gd;

    MyGD_view_dialog(Activity myactivity) {
        activity = myactivity;
    }

    void MyGDViewDialogShow(String fileSelector) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        LayoutInflater inflater = activity.getLayoutInflater();
        builder.setView(inflater.inflate(R.layout.view_my_gd_details, null));
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        gd.setText(document.getString("GD Number"));
